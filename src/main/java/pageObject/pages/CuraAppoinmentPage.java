...
public class CuraAppoinmentPage extends PageTemplate {
    ...
    public WebElement divAppointment;
    ...
    public boolean isOnPage() {
        try {
            ...
            log.error("Check is not on appointment page.");
            return false;
        }
    }

    public void fillAppointmentDetails(String facility, String visitDate, @Nullable String comment) {
